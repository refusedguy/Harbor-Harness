...
///     <see cref="IDiagnosticsPanel" /> ring buffer into plain text lines
///     for inline display inside the RazorConsole chat transcript.
/// </summary>
public sealed class DiagnosticsView
{
    ...
    public IReadOnlyList<string> Render(IDiagnosticsPanel panel, int max = 10)
    {
        ...
        result.Add("──── Logs (last 10, /logs to refresh) ────");
