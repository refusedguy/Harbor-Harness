...
public static class CollectionExtensions
{
    ...
    public static FrozenSet<T> ToFrozenSet<T>(this IEnumerable<T> source, IEqualityComparer<T>? comparer = null)
        where T : notnull => source as FrozenSet<T> ?? FrozenSet.ToFrozenSet(source, comparer);
    ...
    public static FrozenDictionary<TKey, TValue> ToFrozenDictionary<TKey, TValue>(
        ...
        where TKey : notnull => FrozenDictionary.ToFrozenDictionary(source, comparer);
    ...
    public static FrozenDictionary<TKey, TValue> ToFrozenDictionary<TKey, TValue, TSource>(
        ...
        IEqualityComparer<TKey>? comparer = null)
        where TKey : notnull => FrozenDictionary.ToFrozenDictionary(source, keySelector, valueSelector, comparer);
    ...
    /// </summary>
    public static IReadOnlyCollection<T> AsReadOnlyCollection<T>(this IEnumerable<T> source) => source as IReadOnlyCollection<T> ?? source.ToList();
