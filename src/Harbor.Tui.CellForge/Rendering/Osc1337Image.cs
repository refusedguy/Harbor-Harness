...
{
    /// <summary>
    ///     Payload cap (raw bytes before base64): keeps one attachment
    ///     from flooding the tty stream; oversized images fall back to the card.
    /// </summary>
    ...
    /// </summary>
    /// <param name="name">
    ///     File name shown by the terminal (sanitized: ';',
    ...
    /// <summary>
    ///     Replaces envelope-breaking bytes so a hostile file name can
    ///     neither terminate the OSC string nor inject additional File keys.
    /// </summary>
