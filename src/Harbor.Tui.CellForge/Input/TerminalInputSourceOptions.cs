...
/// <summary>
///     Knobs for the terminal input pipeline. Timeouts map to design
///     §2.4 (ESC flush ≈50 ms, env-tunable later) and §4.2 (paste watchdog 10 s).
/// </summary>
public sealed class TerminalInputSourceOptions
{
    ...
    /// <summary>
    ///     Resize polling interval; null disables resize detection
    ///     (SIGWINCH-based detection replaces it in phase 2).
    /// </summary>
