...
/// <summary>
///     Mouse button identity. Numeric values are wire-id + 1
///     (xterm button bits 0/1/2 → Left/Middle/Right).
/// </summary>
...
/// <summary>
///     A decoded SGR-mouse event. Coordinates are zero-based columns/rows
