...
public class GraphicsTests
{
    ...
    {
        byte[] png = MakeFakePng(Graphics.KittyChunkChars * 3 / 4 + 8); // ≥2 base64 chunks
    ...
    public async Task EncodeSixel_EmitsHeaderPaletteAndTerminator()
    {
        ...
        byte[] rgb = new byte[] { 0x39, 0xBA, 0xE6, 0x00, 0x00, 0x00 };
    ...
    {
        byte[] png = new byte[Math.Max(32, totalBytes)];
        png[0] = 0x89;
        png[1] = (byte)'P';
        png[2] = (byte)'N';
        png[3] = (byte)'G';
