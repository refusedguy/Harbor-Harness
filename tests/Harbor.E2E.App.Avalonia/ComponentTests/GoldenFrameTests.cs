...
/// <summary>
///     Minimal toast host for the golden frame — same shape the
///     production MainViewModel exposes (Toasts collection only).
/// </summary>
sealed file class GoldenToastHostViewModel
{
